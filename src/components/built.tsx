const Built = () => {
  return (
    <section class="text-xs flex items-center justify-center flex-col gap-2 mt-14">
      <div class="text-slate-400/60 dark:text-slate-600 text-xs flex items-center justify-center gap-1">
        <span>Built on</span>
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="16" height="16">
          ...
          <defs>
            <linearGradient id="solid_logo_linear_1" x1="0" y1="0" x2="1" y2="0" gradientUnits="userSpaceOnUse" gradientTransform="matrix(16.8011,8.16394,-8.16394,16.8011,4.44465,1.93475)">
            ...
            <linearGradient id="solid_logo_linear_2" x1="0" y1="0" x2="1" y2="0" gradientUnits="userSpaceOnUse" gradientTransform="matrix(-2.94176,9.7973,-9.7973,-2.94176,13.6604,5.93406)">
              <stop stop-color="#76b3e1" stop-opacity="1" offset="0" />
              <stop stop-color="#4377bb" stop-opacity="1" offset="0.5" />
              <stop stop-color="#1f3b77" stop-opacity="1" offset="1" />
            </linearGradient>
            <linearGradient id="solid_logo_linear_3" x1="0" y1="0" x2="1" y2="0" gradientUnits="userSpaceOnUse" gradientTransform="matrix(16.9892,11.5504,-11.5504,16.9892,3.21037,10.207)">
            ...
            <linearGradient id="solid_logo_linear_4" x1="0" y1="0" x2="1" y2="0" gradientUnits="userSpaceOnUse" gradientTransform="matrix(-6.85554,25.1389,-25.1389,-6.85554,10.8812,11.5895)">
